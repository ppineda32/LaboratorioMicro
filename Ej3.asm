...
variable1 DB 'El simbolo escogido es: $' ; $ Significa el final de la cadena
...
programa: ;etiqueta de inicio de probrama
    ...
    mov bl, 236d    ;registro bx de proposito general
    mov dl, bl      ;asignando a dx la variable cadena
